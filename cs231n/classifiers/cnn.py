...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    h, cache_h = affine_relu_forward(a, W2, b2)
    scores, cache_scores = affine_forward(h, W3, b3)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    _, dw3, grads["b3"] = affine_backward(dout,cache_scores)
    _, dw2, grads["b2"] = affine_relu_backward(_,cache_h)
    _, dw1, grads["b1"] = conv_relu_pool_backward(_,cache)
